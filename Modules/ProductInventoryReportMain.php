...
<form name="frmBranchList" method="post" action="ProductInventoryReportMain.php">
<!-- HEADER -->
        ...
        <tr> 
          <td valign="top" class="content">
		  	<table border="0" cellpadding="2" cellspacing="0" width="100%">
                <tr> 
                  <td width="71%" class="content"><span class="text_title">Products </span><span class="text_title">Inventory 
                    Report</span> </td>
                  <td width="29%" class="content"><div align="right"> 
                      <?php
			 	if ($x>0) {
											
			 ?>
                      <input type="button" name="btnPrint" value="Print" class="btn" style="width: 100" onClick="javascript:  window.open('ProductInventoryReport.php?cd=<?=$code?>&name=<?=$name?>&s_stat=<?=$s_stat?>', '', 'menubar=no,width=816,height=700,scrollbars=yes,left=80');">
                    <?php } ?></div></td>
                </tr>
              </table> 
		    <hr>
              ...
              <div  style="z-index:1; overflow: scroll; width: 100%; height: 240;"> 
                <table width="100%" border="0" cellpadding="2" cellspacing="2">
                  ...
                  <tr id="rw<?=$i;?>"> 
                    ...
                    <td nowrap width="39%">&nbsp;<?= $arr[$i]['prod_name']?>
                      &nbsp;</td>
